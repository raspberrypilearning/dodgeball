...
![знімок екрану](images/dodge-gravity-annotated.png)
...
Click the flag, and then drag your character to the top of the Stage. Що трапилось? Does the gravity work as you expect?
...
To do this, create a new variable called `jump height`{:class="block3variables"}. І ви також можете заховати цю змінну.
...
This code moves your character up by 8 pixels, then 7.5 pixels, then 7 pixels, and so on, until it does not rise any higher. Це робить стрибки набагато плавнішими.
